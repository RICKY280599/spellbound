...
class Barrier {
  ...
  void display() {
    ...
    //Decrements when enemies hit the barrier
    // decrementing is done in the Spellbound.pde
    /*if (enemyAtBarrier == true) {
      originalHealthLength -= decrementValue * barrierEnemyCount;
    }*/
